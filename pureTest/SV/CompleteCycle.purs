...
completeBallotTest = do
    it "should compile and deploy the contract, cast randomised votes, retrived and decrypt them, and count those votes correctly." do
        ...
        startTimeStamp <- getBlockTimestamp blockNum
        ...
        -- count ballot
        ballotResultE :: Either String _ <- runBallotCount startTimeStamp votingAddr contract erc20Contract {silent: false} (\_ -> unit)
