...
constructor :: forall e. TransactionOptions NoPay -> HexString -> { _startTime :: (UIntN (D2 :& D5 :& D6)), _endTime :: (UIntN (D2 :& D5 :& D6)), _encPK :: (BytesN (D3 :& D2)), enableTesting :: Boolean, opt1 :: String, opt2 :: String, opt3 :: String, opt4 :: String, opt5 :: String } -> Web3 e HexString
constructor x0 bc r = uncurryFields  r $ constructor' x0 bc
   where
    constructor' :: TransactionOptions NoPay -> HexString -> Tagged (SProxy "_startTime") (UIntN (D2 :& D5 :& D6)) -> Tagged (SProxy "_endTime") (UIntN (D2 :& D5 :& D6)) -> Tagged (SProxy "_encPK") (BytesN (D3 :& D2)) -> Tagged (SProxy "enableTesting") Boolean -> Tagged (SProxy "opt1") String -> Tagged (SProxy "opt2") String -> Tagged (SProxy "opt3") String -> Tagged (SProxy "opt4") String -> Tagged (SProxy "opt5") String -> Web3 e HexString
    constructor' y0 bc' y2 y3 y4 y5 y6 y7 y8 y9 y10 = deployContract y0 bc' ((tagged $ Tuple9 (untagged y2 ) (untagged y3 ) (untagged y4 ) (untagged y5 ) (untagged y6 ) (untagged y7 ) (untagged y8 ) (untagged y9 ) (untagged y10 )) :: ConstructorFn)
